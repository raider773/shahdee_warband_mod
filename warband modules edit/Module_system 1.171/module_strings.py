...
#npc17 = Shahdee
  ...
  ("npc17_intro", "Ah, another would-be hero or another desperate soul looking for a sword to hire? You seem different, I'll give you that. For most, my blade's not cheap, but for you? Let's just say I make exceptions for the intriguing ones. Stick around and maybe you'll learn a thing or two."),
  ...
  ("npc17_intro_response_1", "You talk a big game. What's your story?"),
  ...
  ("npc17_intro_response_2", "I'm not in the mood for charity cases. Good luck out there."),
...
#backstory intro
  ...
  ("npc17_backstory_a", "Curious, aren't you? Well, who wouldn't be? I've tread battlefields and brokered powers for coin and thrill alike. My last contract just ended. Now, I'm in the market for the next exciting opportunity. Maybe it's you, maybe it's not. Let's see where this goes."),
...
#backstory main body
  ...
  ("npc17_backstory_b", "You see, I was leading a squad on a little unofficial raid off the books, good pay. We did the job, got the loot, and everyone was happy. Well, everyone on our side, at least. The other side? Not so much. But that's the life, right? You don't make an omelette without breaking a few skulls. Anyway, I split the share, and went my way. Thought I'd stick around here, see what fortune or trouble I could find myself next."),
...
#backstory recruit pitch
  ...
  ("npc17_backstory_c", "So here I am, armed, experienced, and as free as the wind. You look like you could use someone of my talents, and I could use a new adventure."),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc17_backstory_later", "You again? I've been keeping busy, sweeping through ranks of fools daring enough to cross me. But the thrill fades quickly. What new ventures have you stirred up since we last spoke?"),
  ...
  ("npc17_backstory_response_1", "Always chasing that thrill, huh? I might have a challenge worthy of your skills."),
  ...
  ("npc17_backstory_response_2", "Just checking in. Stay sharp, I'll return when there's work."),
  ...
  ("npc17_signup", "I warn you, I've yet to find a challenge I can't conquer."),
  ...
  ("npc17_signup_2", "As long as the fights are fierce and the stories worth telling, I'm in."),
  ...
  ("npc17_signup_response_1", "Great, let's get going"),
...
#11
  ...
  ("npc17_signup_response_2", "Not just yet. I'll call when the iron's hot and the action's worth your time."),
  ...
  ("npc17_morality_speech", "I trust your judgment, and you know I'm not one to shy away from a bit of chaos. But when we {s21}, it makes me wonder. I'm here for you and the thrill, not for reckless plays. Just making sure we're still on the same page, cap'n."),
  ...
  ("npc17_2ary_morality_speech", "Cap'n -- as for {s21}, it doesn't bother me in the slightest. I joined for action and profit, not morals. If it keeps us ahead and keeps me entertained, I'm all for it. Let the others wring their hands if they wish."),
  ...
  ("npc17_personalityclash_speech", "Cap'n -- as for {s21}, it doesn't bother me in the slightest. I joined for action and profit, not morals. If it keeps us ahead and keeps me entertained, I'm all for it. Let the others wring their hands if they wish."),
  ...
  ("npc17_personalityclash_speech_b", "Cap'n -- as for {s21}, it doesn't bother me in the slightest. I joined for action and profit, not morals. If it keeps us ahead and keeps me entertained, I'm all for it. Let the others wring their hands if they wish."),
...
### set off by behavior after victorious battle
  ...
  ("npc17_personalityclash2_speech", "Beg your pardon, {sir/ma'am}. {s11} might have been a very good thief, but he's not got the stomach to be a warrior, if you ask me."),
  ...
  ("npc17_personalityclash2_speech_b", "After our last scrap, I was slicing open the guts of some our foes to check for hidden gold, as a girl who counts her pennies ought. He gagged and muttered that I was an 'animal.' I'll inspect his innards for contraband if he doesn't keep a civil tongue in his head."), #klethi - borcha
  ...
  ("npc17_personalitymatch_speech", "Oy -- captain. I was just having a chat with {s11}, as we picked through the bodies after our last little scrap."),     
  ...
  ("npc17_personalitymatch_speech_b", "Have you heard her story? Can you believe the wrongs done to her? I tell you, it makes my blood boil. I want to cut off all the little bits of those bastards who mistreated her -- and I'll do it, too, if we ever run into them in our travels."),
  ...
  ("npc17_retirement_speech", "t's been one hell of a ride, cap'n. I've seen battles and plunder that would make lesser souls tremble, and you've always been a leader worth following. But every tale needs an ending, doesn't it? I think it's time I chase a different kind of thrill—something for myself, something new. Don't worry, I'm not hanging up my sword just yet, just swinging it on a new adventure. Who knows? Our paths might cross again on less bloodied roads."),
  ...
  ("npc17_rehire_speech", "Well, look who it is! I've ventured far and wide, cap'n, and let me tell you, it's a wild world beyond our battles. Yet, nothing quite matches the rush of charging into the fray with you leading the charge. I've had my fill of solo adventures for now. If you're still cutting through the chaos and could use another blade by your side, count me in. Ready to dive back into the storm with you, if you'll have me."),
...
#local color strings
  ...
  ("npc17_home_intro", "This land is where i was born, in this city hidden by the desert"),
...
#  ("npc13_home_description", "I had come up here with a small Swadian force, but they were caught by the Rhodoks in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ("npc17_home_description", "This city lies in the heart of the desert, a place both harsh and beautiful. The inhabitants have mastered the art of survival in these arid conditions, relying on ancient aqueducts and underground wells that date back to times when this area was a bustling outpost along forgotten trade routes. The stark landscape hides oases and plots where date palms grow, which are crucial for both sustenance and trade."),
  ...
  ("npc17_home_description_2", "As we draw closer, you might notice the way the buildings are constructed—low and sturdy against the desert winds, with thick walls that keep the interiors cool. The people here are just as resilient, with traditions and hospitality that extend even to strangers. Despite the harsh environment, there's a communal spirit that binds everyone, a shared resolve to not just endure but to flourish."),
  ...
  ("npc17_home_recap", "Though I've wandered far, the desert calls to me like an old friend. Its vastness reminds me of my own journeys, each grain of sand a story, each gust of wind a song from my past travels."),
  ...
  ("npc17_kingsupport_1", "Ruling over these vast lands? That's a venture worthy of the tales, isn't it? You have the cunning and the blade to carve a realm from chaos, much like the old warlords of the desert sands who united tribes under a single banner. I'd follow you into this storm, not just for the thrill, but because I believe you could actually make something better out of this fractured land."), #Shahdee 
  ...
  ("npc17_kingsupport_2", "If you're to be king, then let's be kings of a different sort. Let’s declare the free winds of the desert as our allies. Promise them the right to wander the dunes without chains, and you'll have not just their swords, but their souls. There's an old desert saying — a leader with the desert's blessing cannot be defeated in battle or by deceit."), #Shahdee
  ...
  ("npc17_kingsupport_2a", "That's the spirit! We'd craft a kingdom where every person's worth is judged by their deeds, not birthright. A kingdom that thrives not just in the fertile valleys but also in the harshest sands. Yes, let's write a new chapter in the saga of Calradia."), #Shahdee
  ...
  ("npc17_kingsupport_2b", "Well, perhaps the crown isn't just about conquest and dominion. Maybe it's about understanding the pulse of every market, the songs of every tavern, and the silence of the deserts. If we're to reign, let's ensure it's not just another tyranny cloaked in grandeur."), #Shahdee
  ...
  ("npc17_kingsupport_3", "Give me a few weeks, cap'n, and let me show you how loyalty and strength carve a path to the throne. I'll roam this land, from the darkest alleys to the highest courts, and I'll make them see you as the only rightful {king/queen}. When they whisper your name in awe, remember who put that fear and respect in their hearts."), #Shahdee
  ...
  ("npc17_kingsupport_objection", "Oy -- Captain! I hear that Marnid's gone off to sing a pretty song to the merchants, on how you'll hand them Calradia on a silver platter for them to feast upon, smack their lips, and suck the marrow from the bones. I hope that's just a tale you're telling. A noble lord will at least toss a few coppers to the poor when he holds his feasts, and will make sure that the servants go home with full bellies. A merchant marries his daughter, and you'd be lucky to get a few crusts and scraps of gristle from the table. That's my experience, anyway."), #klethi
...
#
  ...
  ("npc17_intel_mission", "Give me leave for a few days, and I will journey to {s17}. My blade and my wits are well known, and even the most tight-lipped can't help but boast of their schemes when I'm around. I'll gather the whispers and bring you the truth that others would miss."), #Shahdee
  ...
  ("npc17_fief_acceptance", "You honor me with {s17}, cap'n. You've chosen wisely, for who better to hold your lands than one who commands respect and fear alike? I'll rule it as I fight: with strength and loyalty to you alone. Let our enemies quiver, knowing Shahdee holds your banner here."), #Shahdee  
  ...
  ("npc17_turn_against", "Well, cap'n, never thought I’d stand across the battlefield from you. It's ironic, isn’t it? After all the foes we've faced together, here we are. Don’t take it personal, though. You know I always had a flair for the dramatic. Just didn't expect it would lead to this."), #Shahdee
